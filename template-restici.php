			...
			<div class="archive-main row">
				...
				<div class="col-sm-8">
					<div class="archive-main-head">
						...
						<div class="single-body margin-bottom-medium">
	...
	<div id="anchor-3" class="section-post last-posts" style="background-image: url(<?php echo get_field("fond_formule"); ?>)">
		<div class="container">
			<div class="archive-main row">
				...
				<div class="col-sm-8">
					<div class="archive-main-head">
						<h2 class="left-full-border  margin-bottom-medium">Formule</h2>
						<div class="single-body margin-bottom-medium">
	 ...
	 <div id="anchor-4" class="section-post" style="background-image: url(<?php echo get_field('slider_fond'); ?>);">
		<div class="container">
			<h2 class="left-full-border margin-bottom-medium">Photos</h2>
			<div class="single-body margin-bottom-medium"><?php echo get_field("photo-slider"); ?></div>
		</div>
	</div>
</main>
