...
<main id="single-product single-product-pro" class="site-main container-fluid" role="main">
	<!-- Landing -->
	<div class="row section background background--mask" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>); ">
		<div class="container">
	...
	<div id="form-section" class="row section background background--mask" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>); ">
